...
function ComboCard({name,img}) {
    return (
        ...
        <p className="text-gray-700 tracking-wide text-sm group-hover:text-white">Pulled Pork, Beer Braised</p>
        <p className="text-gray-700 tracking-wide text-sm group-hover:text-white">Brisket, & Quarter</p>
        </div>
