        ...
        <div className="bg-brand-pink px-4 py-20 md:px-8">
            <div className="container grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col gap-4">
                    <p className="text-brand-red text-lg font-extrabold mini-headline">DELIVERY</p>
                ...
                <div className="flex flex-col gap-4">
                    <p className="text-brand-red text-lg font-extrabold text-right mini-headline">REWARD</p>
